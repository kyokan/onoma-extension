...
export default class InterstitialWarningModal extends Component {
  ...
  checkDisabled = () => {
    return !this.state.acceptances[0] || !this.state.acceptances[1] || !this.state.acceptances[2];
  };
    ...
    return (
      <MiniModal closeRoute="/settings" title="Are you sure you want to do this?">
        ...
        <div className="interstitial-warning-modal__buttons">
          <button className="interstitial-warning-modal__cancel-button" onClick={this.onClickCancel}>
            Cancel, keep wallet
          </button>
          <button
