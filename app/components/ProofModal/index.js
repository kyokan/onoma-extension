...
export default class ProofModal extends Component {
  ...
  render() {
    const { onClose, address, stepOneInstruction, stepTwoInstruction, onSubmit } = this.props;
      ...
      <Modal className="proof" onClose={onClose}>
        <div className="proof__container">
          <div className="proof__header">
            <div className="proof__title">Claim your coins with a proof</div>
            <div className="proof__close-btn" onClick={onClose}>✕</div>
          </div>
          ...
          <div className="proof__footer">
            <button className="proof__submit-btn" onClick={onSubmit}>Add Proof</button>
          </div>
        </div>
      </Modal>
    );
